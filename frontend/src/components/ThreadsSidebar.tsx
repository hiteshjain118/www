...
const ThreadsSidebar: React.FC<ThreadsSidebarProps> = ({ 
  userCbid,
  selectedThreadId, 
  onThreadSelect, 
  onThreadCreate 
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <div className="p-4 text-center text-gray-500">
            ...
            <p className="mt-4 text-sm">No threads yet</p>
            <p className="text-xs text-gray-400 mt-1">Create your first thread to get started</p>
          </div>
        ) : (
          <div className="py-2">
            {threads.map((thread) => (
              <div
                ...
                className={`mx-2 mb-1 p-3 rounded-lg cursor-pointer transition-colors duration-150 ${
